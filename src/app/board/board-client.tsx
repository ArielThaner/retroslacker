...
function BoardContent({
  ...
  // Countdown runs on every Board visit regardless of the stored session
  // status. "Join Live Session" is no longer a distinct UI — the Board always
  // shows the countdown → Join Retro flow.
  useEffect(() => {
